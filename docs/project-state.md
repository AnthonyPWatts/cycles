...
- The API exposes current Cycle, empire summary, galaxy, fleets, fleet detail, order queue, movement orders, attack orders, priorities, recent events, and Chronicle entries.
