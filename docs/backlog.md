...
| Same-phase resource contention | [#139](https://github.com/AnthonyPWatts/cycles/issues/139), [#154](https://github.com/AnthonyPWatts/cycles/issues/154) | Reserve at closure; when the budget cannot fund every otherwise-eligible Colonise intention, reject the whole set rather than select a hidden winner. |
