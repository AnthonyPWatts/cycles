...
| Command decision hierarchy | [#159](https://github.com/AnthonyPWatts/cycles/issues/159) | Implemented without a replacement mini-map: Galaxy is the only spatial board, while Command opens with decisions and next-resolution consequences before intelligence and the commitment calendar. |
