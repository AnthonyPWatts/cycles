...
| Command decision hierarchy | [#159](https://github.com/AnthonyPWatts/cycles/issues/159) | Remove the parallel Frontier Schematic, keep Galaxy as the only spatial board, and use Command's opening space for current decisions, outcomes, commitments, journeys, and forecast consequences. |
