...
If you are running the project on your own machine, follow the [run instructions](../README.md#run) and open `/app.html` on the local site.
...
![Cycles command map](images/cycles-dashboard-map.png)
...
![A pending attack order](images/cycles-dashboard-attack-order.png)
...
![A battle preserved in the Chronicle](images/cycles-dashboard-chronicle.png)
