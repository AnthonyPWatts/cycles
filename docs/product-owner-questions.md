...
Q023-Q025 were answered on 2026-07-18 by retaining the fully visible galaxy topology, keeping active fleets as the baseline source of detailed visibility, and automatically sharing that visibility between allies. Q028 was answered on 2026-07-24 by retaining own-empire Events outside local visibility. Stale-contact detail and other intelligence rules remain gated by Q026-Q027 and Q029-Q034.

Q060 was answered on 2026-07-18 by sequencing diplomacy before richer combat. Q059, Q063-Q064, and Q069-Q070 were answered on 2026-07-24 by accepting the current simple combat, deterministic target selection, implicit Hold, next-tick activation, and durable bounded-history defaults for the first viable game.

Q071 was answered on 2026-07-18 by treating admirals as both narrative anchors and eventual strategic assets, while keeping the next slice narrative-first. Q077 and Q080 were answered on 2026-07-24 by tying death to destruction of the commanded fleet and keeping the fleet panel to the current name, reputation, and status summary.

Q082-Q084 were answered on 2026-07-18 and clarified on 2026-07-19: retain the top-10% historical preservation rule, reset player and empire mechanics completely, confer no inherited winner recognition or advantage, and allow accumulated history to create galaxy-level physical, strategic, and naming echoes. Q088 was answered on 2026-07-24 by retaining fresh, deterministic, rank-neutral successor identities without first-version player selection.
...
Q097 was answered on 2026-07-18 by requiring a provider-neutral narrative boundary with replaceable live-provider connectors and a deterministic development/test connector. Q095-Q096 and Q102 were answered on 2026-07-24 by keeping factual summaries and deterministic fallback text player-visible, provider failures admin-only, and Chronicle thresholds globally code/config-owned. Q094, Q098-Q101, and Q103-Q106 still gate the first production narrative pipeline.

Q055 was answered on 2026-07-24 by retaining home-fleet construction until scale or play evidence justifies rally points.
...
The 17 July development-match decision supersedes the four-empire opening without changing the 8-sector, 64-system map boundary. The current seed uses Tony and Will as persistent human players plus Ariadne as a game-AI player, each controlling one of three empires in distinct sectors. The match model permits up to six empire participants and never shares control of an empire. The 22 July identity decisions select direct Google OIDC for the hosted playground, with a one-time verified-email invitation binding each person to the existing Tony or Will Player and issuer/subject thereafter. Anthony is the sole initial operator/admin and Will remains an ordinary Player. The Development selector remains local and temporarily hosted only until the coordinated Google, Cloudflare and Azure configuration is ready; matchmaking and production game-AI policy remain deferred.

The approved 19 July [multi-game and tutorial programme](multi-game-and-tutorial-plan.md) separates Training from standard Games. A Game contains one or more Cycle epochs; a persistent Player may hold several Game enrolments while Cycle participant and empire authority remain separate. Twin Reaches supplies the first one-human Training profile and four-resolution Core journey, while the current canonical galaxy supplies the first standard profile. Players reconfirm during Intermission, the first release uses in-app urgency, and email or push waits for return evidence. Public discovery, queues, no-shows, AI fill, player-created Games, and any private automatic-successor policy remain future decisions. The 20 July decision makes Training the sole guided journey: Standard retains the Council Agenda and genuine opening objectives as ordinary gameplay but no tutorial button, client-local tutorial state, or tutorial-specific advance gate. This direction adds no scope to issue #138.
...
Q127's 2026-07-14 answer was superseded on 2026-07-20. The server-backed Twin Reaches `Core foundations` journey is now the sole in-dashboard training path; Standard games retain ordinary opening objectives but no tutorial surface or client-local tutorial progression.
...
| [Q060](https://github.com/AnthonyPWatts/cycles/issues/48) | Implement diplomacy before richer combat choices. Keep combat simple while diplomacy and visibility settle; defer ship classes and tactical postures. | Combat playtesting and clarity work may continue, but richer rule changes remain behind diplomacy, visibility, the unanswered combat questions, and evidence from #131. Q059, Q063-Q064, and Q069-Q070 now preserve the current first-viable-game defaults. |
| [Q071](https://github.com/AnthonyPWatts/cycles/issues/59) | Admirals are both narrative anchors and eventual strategic assets. Keep the next slice narrative-first before adding power. | Existing history, reputation, status, and famous-system data remain the safe presentation foundation. Q077 and Q080 now retain the current death and compact-display defaults; the remaining admiral questions still select actual bonuses, recruitment, biography, and management behaviour. |
...
| [Q084](https://github.com/AnthonyPWatts/cycles/issues/72) | The winner receives no inherited title, banner, home-system flavour, prestige, or other next-Cycle benefit. Their benefit is the impact recorded in overall history. | End-of-Cycle rankings and history remain authoritative, but the next Cycle does not confer winner-specific recognition or advantage. Q088 now keeps successor identity fresh and rank-neutral; Q085-Q087, Q089-Q091, and Q093 still own disclosure, summaries, significance evolution, and exports; Q092 permits historical names to evolve. |
...
| [Q097](https://github.com/AnthonyPWatts/cycles/issues/85) | Keep narrative generation provider-neutral through a small interface with replaceable connectors for live providers. Retain a deterministic connector for development and testing rather than coupling the model to one vendor. | Do not select a concrete vendor or build an offline-only content library as the product boundary. Q095-Q096 and Q102 now settle failure/fallback and threshold ownership; Q094, Q098-Q101, and Q103-Q106 still own queue scope, tone, inference, required facts, review, interactions, privacy, and versioning. |

## Accepted First-Viable-Game Defaults

The product owner accepted these answers on 2026-07-24. They preserve deliberate current behaviour while Cycles establishes whether the core game is viable. A later playtest may justify a bounded follow-up issue; accepting a default does not authorise speculative expansion or prevent later revision.

| Question | Accepted answer | Consequence |
| --- | --- | --- |
| [Q028](https://github.com/AnthonyPWatts/cycles/issues/16) | A Player always sees Events involving their own empire, even when the Event's system is outside current local visibility. | Keep unrelated remote enemy Events hidden. Local visibility and deliberately global lifecycle Events remain separate visibility reasons. |
| [Q055](https://github.com/AnthonyPWatts/cycles/issues/43) | Construction continues joining the home fleet. Do not add rally-point selection before map scale or play evidence demonstrates a need. | Preserve the current simple delivery rule. Any rally-point mechanic requires a bounded proposal covering selection, visibility, capture, and invalidation. |
| [Q059](https://github.com/AnthonyPWatts/cycles/issues/47) | The current deterministic, ship-count-proportional combat model is acceptable for the next playable test. | Do not make balancing or richer combat a near-term priority without repeatable evidence from #131. |
| [Q063](https://github.com/AnthonyPWatts/cycles/issues/51) | An Attack targets the selected hostile empire or faction when supplied; otherwise the resolver selects the largest local hostile faction using a stable tie-break. | Do not add fleet-level targets, posture targets, or hidden target heuristics to the first viable game. |
| [Q064](https://github.com/AnthonyPWatts/cycles/issues/52) | Do not expose a separate Player Hold control yet. A fleet without another intention receives a durable implicit Hold when the command window closes, and Hold has no special bonus beyond remaining in place. | Preserve the sealed-ledger audit distinction between an implicit Hold and other command sources without adding a redundant dashboard action. |
| [Q069](https://github.com/AnthonyPWatts/cycles/issues/57) | Player intentions activate on the next tick. Multi-tick travel is the continuing effect of an already-processed Move, not delayed command activation. | Longer activation requires a named mechanic whose planning value justifies its waiting and feedback cost. |
| [Q070](https://github.com/AnthonyPWatts/cycles/issues/58) | Retain every order with its Cycle as durable history, including rejection reasons and supersession links. Keep ordinary Player queries bounded and filterable. | Do not hard-delete at Cycle end. Consider cold archival only after measured storage or query pressure, while preserving the complete audit contract. |
| [Q077](https://github.com/AnthonyPWatts/cycles/issues/65) | An admiral dies only when the commanded fleet is destroyed. Do not add random, common, or opt-in death. | A surviving commanded fleet cannot lose its admiral through an unrelated chance roll; a destroyed commanded fleet kills its assigned admiral under the current deterministic rule. |
| [Q080](https://github.com/AnthonyPWatts/cycles/issues/68) | Keep the fleet panel to the admiral's name, reputation, and status. | Battle history and famous-system associations remain durable facts for History or a later expanded view; biography and traits wait for evidence and their own decisions. |
| [Q088](https://github.com/AnthonyPWatts/cycles/issues/76) | Use the new Cycle's roster and profile to assign fresh successor identities through the current deterministic rule, without using prior rank. Do not add Player identity selection in the first version. | Returning Players receive fresh empires without winner/loser mapping, participant-specific continuity, inherited power, or a new enrolment choice flow. |
| [Q095](https://github.com/AnthonyPWatts/cycles/issues/83) | If live narrative generation is delayed or fails, keep the factual summary and deterministic fallback text visible to Players. A pending state may describe queued work; provider failure detail is admin-only. | Narrative availability cannot hide authoritative history or expose provider internals. |
| [Q096](https://github.com/AnthonyPWatts/cycles/issues/84) | Deterministic templates remain the fallback after live narrative generation exists. | Provider outages, retries, or later connector changes do not remove readable Chronicle prose. |
| [Q102](https://github.com/AnthonyPWatts/cycles/issues/90) | Keep Chronicle importance thresholds global and owned by code/configuration for now rather than configurable per Cycle. | Do not add Player or Cycle setup controls. Event-type-specific thresholds may be introduced only with a new record type and evidence that one global policy is insufficient. |
...
| --- | --- | --- |
| Tutorial game | Use Twin Reaches as the first compact Training profile and sole guided journey: ten systems, thirteen routes, one human seat, ordinary mechanics, a four-resolution Core journey, server-derived progress, and fresh-attempt reset rather than rewind. Standard games expose no tutorial UI. | Complete the first-outcome, unaided-completion, accessibility, and false-learning pilot gates for Training; those gates do not retain obsolete tutorial controls in Standard. |
...
| [Q123](https://github.com/AnthonyPWatts/cycles/issues/111) | Keep raw `FactJson` out of the normal dashboard and ordinary player API. Use display text by default and add purpose-built typed detail contracts only where they provide player value. | Event and battle storage may remain flexible internally. The Standard Council Agenda and opening-objective hand-offs receive a typed opening briefing rather than parsing storage JSON; this is an ordinary gameplay contract, not tutorial progress. Any raw operator view remains an explicit authorised diagnostic. Implementation is tracked by [issue #127](https://github.com/AnthonyPWatts/cycles/issues/127). |
...
| [Q127](https://github.com/AnthonyPWatts/cycles/issues/115) | Superseded on 2026-07-20: use the server-backed Twin Reaches `Core foundations` journey as the sole in-dashboard training path. Standard retains the Council Agenda and genuine opening objectives as ordinary gameplay, without a guide button, client-local tutorial state, or tutorial-specific advance gate. | Keep Training guidance tied to real controls and authoritative outcomes. Remove the obsolete Standard tutorial surface without waiting for the Training pilot gates. Training accessibility and comprehension evidence remain tracked by [issue #129](https://github.com/AnthonyPWatts/cycles/issues/129). |
...
- The server-backed Twin Reaches `Core foundations` journey is the sole in-dashboard training path. Standard games retain the Council Agenda and genuine opening objectives as ordinary gameplay but expose no guide button, client-local tutorial progress, or tutorial-specific advance gate.
...
| Visibility and intelligence | Q026-Q027 and Q029-Q034 | Contact precision and persistence, remote control changes, Chronicle disclosure, destroyed-fleet intelligence, sensors, historical-system visibility, and live ranking exposure. Q023-Q025 retain full topology, active-fleet detail, and automatic allied sharing; Q028 preserves own-empire Events outside local visibility. |
...
| Population, infrastructure, and comeback | Q050-Q052, Q054, and Q056 | Comeback rules, home-system protection, ship classes, and capacity limits. Q055 retains home-fleet construction until rally-point evidence exists; Q047-Q049 confirm the current outpost model; Q053 and Q057 settle the next Industry direction and first-version output boundary; Q058 permits history-driven successor-system echoes without participant carry-over. |
| Combat | Q061-Q062 and Q065-Q068 | Postures, retreat, fleet composition, multi-empire battles, and travel modifiers. Q059-Q060 accept simple combat for the next playable test; Q063-Q064 accept deterministic faction targeting and implicit Holds; Q069-Q070 retain next-tick activation and durable bounded order history. |
| Admirals | Q072-Q076 and Q078-Q079 | Bonus scope, transfers, Player management, Legendary behaviour, diplomacy outcomes, recruitment, and biography. Q071 establishes narrative-first now with strategic effects later; Q077 ties death to commanded-fleet destruction; Q080 keeps the fleet panel compact; Q081 permits an admiral association to change both the figure's history and later galaxy naming. |
| Cycle continuity | Q085-Q087, Q089-Q091, Q093, and [#157](https://github.com/AnthonyPWatts/cycles/issues/157) | Disclosure, cutoff handling, lifecycle controls, defeated-empire flavour, summaries, significance evolution, export, and the narrative reason for the break between Cycles. Q082-Q084 reset participants while retaining selected history and galaxy echoes; Q088 keeps successor identity fresh and rank-neutral; Q092 permits names to evolve. |
| Chronicle AI | Q094, Q098-Q101, and Q103-Q106 | Queue ownership, tone, inference, required facts, review, interactions, privacy, and versioning. Q095-Q097 retain visible factual/deterministic fallback and a provider-neutral connector boundary; Q102 keeps thresholds globally code/config-owned. |
